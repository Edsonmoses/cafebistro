...
class BistoRecipie4colComponent extends Component
{
    public function render()
    {
        ...
        SEOMeta::setCanonical('https://www.cafebistro.co.ke/recipie-4-col');
        return view('livewire.pages.bisto-recipie4col-component')->layout('layouts.base');
    }
}
