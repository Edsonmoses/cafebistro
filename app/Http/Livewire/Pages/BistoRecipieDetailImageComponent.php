...
class BistoRecipieDetailImageComponent extends Component
{
    public function render()
    {
        ...
        SEOMeta::setCanonical('https://www.cafebistro.co.ke/recipie-detail');
        return view('livewire.pages.bisto-recipie-detail-image-component')->layout('layouts.base');
    }
}
