                    ...
                    <div class="row wow fadeInUp">
                        <div class="col-md-9">
                            <article>
                                <div class="post-img">
                                    <div class="blog-slider">
                                        <div>
                                            <img src="{{ asset('assets/frontend/img/blog/1.jpg')}}" class="img-responsive" alt="" />
                                        </div>
                                        <div>
                                            <img src="{{ asset('assets/frontend/img/blog/2.jpg')}}" class="img-responsive" alt="" />
                                        </div>
                                        <div>
                                            <img src="{{ asset('assets/frontend/img/blog/3.jpg')}}" class="img-responsive" alt="" />
                                        </div>
                                    </div>
                            ...
                            <article>
                                <div class="post-img">
                                    <div class="video">
                                        <iframe src="http://player.vimeo.com/video/84161223?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff&amp;autoplay=0"></iframe>
                                    </div>
                        ...
                        <aside class="col-md-3">
                            ...
                            <div class="side-widget">
                                ...
                                <ul class="recent-post">
                                    <li>
                                        <img src="{{ asset('assets/frontend/img/blog/1/1.jpg')}}" alt="" />
                                        <div class="rp-info">
                                    ...
                                    <li>
                                        <img src="{{ asset('assets/frontend/img/blog/1/2.jpg')}}" alt="" />
                                        <div class="rp-info">
                                    ...
                                    <li>
                                        <img src="{{ asset('assets/frontend/img/blog/1/3.jpg')}}" alt="" />
                                        <div class="rp-info">
                                            <a href="./blog_single_image.html">Post Heading Here</a>
