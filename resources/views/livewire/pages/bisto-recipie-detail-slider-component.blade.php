                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="single-recipe-carousel">
                                <div>
                                    <img class="img-responsive" src="{{ asset('assets/frontend/img/recipie/single/1.jpg')}}" alt="">
                                </div>
                                <div>
                                    <img class="img-responsive" src="{{ asset('assets/frontend/img/recipie/single/2.jpg')}}" alt="">
                                </div>
                                <div>
                                    <img class="img-responsive" src="{{ asset('assets/frontend/img/recipie/single/3.jpg')}}" alt="">
                                </div>
                                <div>
                                    <img class="img-responsive" src="{{ asset('assets/frontend/img/recipie/single/4.jpg')}}" alt="">
                                </div>
                                <div>
                                    <img class="img-responsive" src="{{ asset('assets/frontend/img/recipie/single/5.jpg')}}" alt="">
                                </div>
                                <div>
                                    <img class="img-responsive" src="{{ asset('assets/frontend/img/recipie/single/6.jpg')}}" alt="">
                                </div>
                                <div>
                                    <img class="img-responsive" src="{{ asset('assets/frontend/img/recipie/single/7.jpg')}}" alt="">
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="featured-recipies">
                            <div class="fp-content">
                                <a href="./recipe_detail-image.html"><img src="{{ asset('assets/frontend/img/recipie/1/1.jpg')}}" class="img-responsive" alt="" /></a>
                            ...
                            <div class="fp-content">
                                <a href="./recipe_detail-image.html"><img src="{{ asset('assets/frontend/img/recipie/1/2.jpg')}}" class="img-responsive" alt="" /></a>
                                <h4><a href="./recipe_detail-image.html">Food Name</a></h4>
                                <div class="rc-ratings">
                                    <span class="fa fa-star"></span>
                                    <span class="fa fa-star active"></span>
                            ...
                            <div class="fp-content">
                                <a href="./recipe_detail-image.html"><img src="{{ asset('assets/frontend/img/recipie/1/3.jpg')}}" class="img-responsive" alt="" /></a>
                                <h4><a href="./recipe_detail-image.html">Food Name</a></h4>
                                <div class="rc-ratings">
                                    <span class="fa fa-star"></span>
                                    <span class="fa fa-star active"></span>
                            ...
                            <div class="fp-content">
                                <a href="./recipe_detail-image.html"><img src="{{ asset('assets/frontend/img/recipie/1/4.jpg')}}" class="img-responsive" alt="" /></a>
                                <h4><a href="./recipe_detail-image.html">Food Name</a></h4>
                                <div class="rc-ratings">
                                    <span class="fa fa-star"></span>
                                    <span class="fa fa-star active"></span>
