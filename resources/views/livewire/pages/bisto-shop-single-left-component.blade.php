                        ...
                        <aside class="col-md-3">
                            ...
                            <div class="side-widget">
                                ...
                                <ul class="recent-products">
                                    <li>
                                        <img src="{{ asset('assets/frontend/img/shop/1/1.png')}}" alt="" />
                                        <div class="rpp-info">
                                    ...
                                    <li>
                                        <img src="{{ asset('assets/frontend/img/shop/1/2.png')}}" alt="" />
                                        <div class="rpp-info">
                                            <a href="./shop_single_full.html">Lorem ipsum is simp</a>
                                            <div class="rc-ratings">
                                                <span class="fa fa-star active"></span>
                                    ...
                                    <li>
                                        <img src="{{ asset('assets/frontend/img/shop/1/3.png')}}" alt="" />
                                        <div class="rpp-info">
                                            <a href="./shop_single_full.html">Lorem ipsum is simp</a>
                                            <div class="rc-ratings">
                                                <span class="fa fa-star active"></span>
                        ...
                        <div class="col-md-9">
                            <div class="col-md-6">
                                <div class="single-shop-carousel">
                                    <div>
                                        <img class="img-responsive" src="{{ asset('assets/frontend/img/shop/single/1.jpg')}}" alt="">
                                    </div>
                                    <div>
                                        <img class="img-responsive" src="{{ asset('assets/frontend/img/shop/single/2.jpg')}}" alt="">
                                    </div>
                                    <div>
                                        <img class="img-responsive" src="{{ asset('assets/frontend/img/shop/single/3.jpg')}}" alt="">
                                    </div>
                                    <div>
                                        <img class="img-responsive" src="{{ asset('assets/frontend/img/shop/single/1.jpg')}}" alt="">
                                    </div>
                                    ...
                                    <div style="" class="tab-pane fade" id="mini-two">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="comment-list">
                                                <li>
                                                    <a class="pull-left" href="./index.html"><img class="comment-avatar" src="{{ asset('assets/frontend/img/xtra/1.jpg')}}" alt="" height="50" width="50"></a>
                                                ...
                                                <li>
                                                    <a class="pull-left" href="./index.html"><img class="comment-avatar" src="{{ asset('assets/frontend/img/xtra/2.jpg')}}" alt="" height="50" width="50"></a>
                                                    <div class="comment-meta">
