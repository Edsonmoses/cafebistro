      ...
      <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 text-right mt-5"  style="margin-top: 2.5em">
                <a href="{{route('admin.addpcategory')}}" type="button" class="btn btn-success">Add Category</a>
            </div>
            <div class="col-md-12">
                <table class="table" style="margin-top: 2.5em">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    <a href="{{ route('admin.editpcategory',['slug'=>$category->slug]) }}"><i  class="fa fa-edit fa-1x"></i></a>
