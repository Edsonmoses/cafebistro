    ...
    <section>
      <div class="container">
        <div class="row" style="padding: 20px 0">
            <div class="col-md-12">
                 <a class="btn btn-info pull-right" style="margin: 10px 0 0 0" href="{{ route('admin.trusted') }}">All Logos</a>
            ...
            <div class="col-md-6">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        @else
                        <img src="{{asset('assets/frontend/img/sponsor')}}/{{ $image }}" width="120"/>
                        @endif
                    </div>
                    <button type="submit" class="btn btn-default" wire:click.prevent="updateTrusted()">Update</button>
            </div>
            <div class="col-md-6">
                    <div class="form-group">
