    ...
    <section>
      <div class="container">
        <div class="row" style="padding: 20px 0">
             <div class="col-md-12">
                 <a class="btn btn-info pull-right" style="margin: 10px 0 0 0" href="{{ route('admin.pcategory') }}">All Categories</a>
            ...
            <div class="col-md-6">
                ...
                <form>
                    ...
                    <button type="submit" class="btn btn-default" wire:click.prevent="updateCategory()">Submit</button>
            </div>
            <div class="col-md-6">
                    <div class="form-group">
